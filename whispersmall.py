...
WHISPER_MODEL_SIZE = 'small'  # Can be 'base', 'medium', 'large'
...
model = WhisperModel(WHISPER_MODEL_SIZE, device="cpu")  # Use 'cuda' if available
...
def main():
    ...
    print("Hold F9 to capture screenshot and record speech.")
